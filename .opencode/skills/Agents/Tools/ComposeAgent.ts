 ...
 *   User:  ~/.opencode/PAI/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
 *
 * Usage:
...
const USER_TRAITS_PATH = `${HOME}/.opencode/PAI/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml`;
...
CONFIGURATION:
  ...
  User traits:  ~/.opencode/PAI/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
