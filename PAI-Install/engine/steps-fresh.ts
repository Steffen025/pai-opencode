...
#
# Provider API keys are configured via /connect inside OpenCode.
# OpenCode Zen (free models) works without any API key.
#
# To add a premium provider, start OpenCode and run:
#   /connect
#
# Or set keys here manually:
